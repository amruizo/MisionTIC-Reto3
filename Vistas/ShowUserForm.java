...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void receiveData(int idEmp, String nombreEmp, String apellidos, String TipoDocumento, String documento, String correo){
        System.out.println(idEmp + " " + nombreEmp + " " + documento + " " +TipoDocumento+" "+correo );
        txtId.setText(""+idEmp); //Convertir int en texto
    ...
    private void initComponents() {
        ...
        txtId.setFont(new java.awt.Font("Ubuntu Light", 0, 18)); // NOI18N
